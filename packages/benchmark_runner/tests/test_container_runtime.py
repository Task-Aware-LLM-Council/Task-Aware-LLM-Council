...
def test_build_apptainer_server_config_from_provider_defaults() -> None:
    ...
    launch = build_apptainer_server_config(config)
...
async def test_apptainer_server_handle_start_returns_api_base(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "benchmark_runner.container_runtime.asyncio.create_subprocess_exec",
        fake_create_subprocess_exec,
    )
    monkeypatch.setattr(
        "benchmark_runner.container_runtime.ApptainerServerHandle._wait_until_ready",
